...
export const renderScores = async (game) => {
  ...
  scores.style.top = '8rem'
  scores.style.width = '90vw'
  ...
  const topFive = currScores.sort((f, s) => s.score - f.score).slice(0, 10)
...
const renderInfo = () => {
  ...
  index3.textContent = `Highest Score Until 00:00 On 26.05 Wins A Gift From Us.`
